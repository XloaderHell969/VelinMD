...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '6288294029936@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        title: `${ucapanWaktu} ${pushname}`,
        body: "ᴋᴏɴᴇᴋᴏ-ᴍᴅ",
        thumbnailUrl: "https://i.ibb.co/X5RqTRK/adrian.jpg",
        sourceUrl: "https://chat.whatsapp.com/ecxecrxcrexrexrexxrx",
        mediaType: 1,
        renderLargerThumbnail: true
      }
    }
...
let e = String(err)
conn.sendMessage("6288294029936@s.whatsapp.net", { text: "👋🏻 Hello developer, ada yang error nih! di bagian " + util.format(e), 
contextInfo:{
